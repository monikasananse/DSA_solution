...
// Now, the value of sum2 is greater than the value stored in six, but the value stored in sum1 is not greater than the value stored in three, Therefore, the answer is No


function twoSumsOneNumber(one, two, three, four, five, six) {
    // Write code here
    var sum1=one+two;
    var sum2=four+five;
...
twoSumsOneNumber(46,9,23,79,25,79);